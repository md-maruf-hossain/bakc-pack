...
const Carousel = () => {
  ...
  return (
    <section className="container px-4 my-12 h-3/4 relative">
      <img src={CAROUSEL_DATA[currentIndex].url} className="rounded-md" alt="" />
      <div onClick={decrementIndex} className="absolute left-8 top-1/2 -translate-y-1/2 bg-white rounded p-1 cursor-pointer">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
        </svg>
      </div>

      <div onClick={incrementIndex} className="absolute right-8 top-1/2 -translate-y-1/2 bg-white rounded p-1 cursor-pointer">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
